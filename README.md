...
| [google-analytics-types](core/google-analytics-types/README.md)           | ![npm version image](https://img.shields.io/npm/v/%40stephansama%2Fgoogle-analytics-types?logo=npm&logoColor=red&color=211F1F&labelColor=211F1F)      | ![npm downloads](https://img.shields.io/npm/dw/@stephansama/google-analytics-types?labelColor=211F1F)      | TypeScript types for Google Tag Manager dataLayer + GA4 gtag recommended events.              |
