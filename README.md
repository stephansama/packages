...
| [typed-config](core/typed-config/README.md)                               | ![npm version image](https://img.shields.io/npm/v/%40stephansama%2Ftyped-config?logo=npm&logoColor=red&color=211F1F&labelColor=211F1F)                | ![npm downloads](https://img.shields.io/npm/dw/@stephansama/typed-config?labelColor=211F1F)                | Standard-Schema-validated config loader with XDG + TOML support, built on cosmiconfig.        |
