...
| [markdown-pipeline](core/markdown-pipeline/README.md)                     | ![npm version image](https://img.shields.io/npm/v/%40stephansama%2Fmarkdown-pipeline?logo=npm&logoColor=red&color=211F1F&labelColor=211F1F)           | ![npm downloads](https://img.shields.io/npm/dw/@stephansama/markdown-pipeline?labelColor=211F1F)           | Composable factory for a shared remark/rehype pipeline across stars + blog.                   |
