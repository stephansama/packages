...
[![yaml](https://img.shields.io/badge/yaml-catalog:-CB171E.svg?logo=yaml&logoColor=ffffff&labelColor=CB171E)](https://npmx.dev/package/yaml)
...
| `badgeOptions`              |                                                             | _Object with properties:_<ul><li>`dependencyTypes`: [BadgeDependencyTypeOptions](#badgedependencytypeoptions)</li><li>`templates`: `Array<string>` - handlebar template strings where {{name}} / {{key}} and {{version}} / {{value}} represent the package</li></ul>                                                              | `{"dependencyTypes":["dependencies","devDependencies"],"templates":[]}`                                                                                                                                                                                                                                                                                                                        |
