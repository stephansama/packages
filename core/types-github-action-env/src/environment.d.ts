...
interface GitHubEnvironments {
	 ...
	 * composite actions. You can use this path to change directories to where
	 * the action is located and access other files in that same repository. For
	 ...
	 * Actions](https://docs.github.com/en/actions/reference/workflows-and-actions/workflow-commands#setting-an-environment-variable).
	 */
	 ...
	 * commands for GitHub
	 * Actions](https://docs.github.com/en/actions/using-workflows/workflow-commands-for-github-actions#setting-an-output-parameter).
	 */
	 ...
	 * For more information, see [Workflow commands for GitHub
	 * Actions](https://docs.github.com/en/actions/using-workflows/workflow-commands-for-github-actions#adding-a-system-path).
	 */
	 ...
	 * For more information, see [Workflow commands for GitHub
	 * Actions](https://docs.github.com/en/actions/using-workflows/workflow-commands-for-github-actions#adding-a-job-summary).
	 */
	 ...
	 * runners](https://docs.github.com/en/actions/using-github-hosted-runners/about-github-hosted-runners#supported-software).
